...
import com.weedong.flex.messaging.io.ASRecordSet;
        ...
        */
        ...
        try {
            List<PropertyDescriptor> properties =
                PropertyDescriptorHelper.getPropertyDescriptors(object);
            for (int i = 0; i < properties.size(); i++) {
                if (!properties.get(i).getName().equals("class")) {
                    String propertyName = properties.get(i).getName();
                    Method readMethod = properties.get(i).getReadMethod();
