...
package com.weedong.flex.messaging.amf.io.util;
...
import com.weedong.flex.messaging.util.ClassUtil;
import com.weedong.util.PropertyDescriptorHelper;
import com.weedong.util.PropertyDescriptor;
        ...
        public void defineProperty(String name) {
            ...
            if (type.length() == 0)
                ...
                try {
                    ...
                    for (PropertyDescriptor prop : PropertyDescriptorHelper.getPropertyDescriptors(clazz)) {
        ...
        protected List<Property> introspectProperties() {
            ...
            if (!isExternalizable() && !Map.class.isAssignableFrom(type) && !Hashtable.class.isAssignableFrom(type)) {
                try {
                    ...
                    for (PropertyDescriptor property : PropertyDescriptorHelper.getPropertyDescriptors(type)) {
