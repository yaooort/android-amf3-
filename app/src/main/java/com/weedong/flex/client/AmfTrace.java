...
public class AmfTrace extends ObjectTrace
{
    ...
    public void startAMFArray(int ref)
    {
        ...
        buffer.append("(Array #").append(ref).append(")").append(StringUtil.NEWLINE);
        m_indent++;
        m_nested++;
    }
    ...
    public void startECMAArray(int ref)
    {
        ...
        buffer.append("(ECMA Array #").append(ref).append(")").append(StringUtil.NEWLINE);
        m_indent++;
        m_nested++;
    }
    ...
    public void startByteArray(int ref, int length)
    {
        ...
        buffer.append("(Byte Array #").append(ref).append(", Length ").append(length).append(")").append(StringUtil.NEWLINE);
    }
    ...
    public void startExternalizableObject(String type, int ref)
    {
        ...
        buffer.append("(Externalizable Object #").append(ref).append(" \'").append(type).append("\')").append(StringUtil.NEWLINE);
    ...
    public void startAMFObject(String type, int ref)
    {
        ...
        if (type != null && type.length() > 0)
            buffer.append("(Typed Object #").append(ref).append(" \'").append(type).append("\')").append(StringUtil.NEWLINE);
        else
            buffer.append("(Object #").append(ref).append(")").append(StringUtil.NEWLINE);
