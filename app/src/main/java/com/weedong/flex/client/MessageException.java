...
public class MessageException extends LocalizedException
{
    ...
    public ErrorMessage createErrorMessage()
    {
        ...
        msg.setFaultCode(code != null? code : "Server.Processing");
        msg.setFaultString(message);
        msg.setFaultDetail(details);
        msg.setRootCause(getRootCauseErrorMessage());
    ...
    public void logAtHingePoint(Message inboundMessage, ErrorMessage outboundMessage, String logMessageIntro)
    {
        if (!isLogged())
        {
            ...
            output.append(StringUtil.NEWLINE);
